			...
			<div class="ri_edit">
				...
				if (act.equals("reply") && request.getParameter("arti_id") != null) {
					...
					try {
						...
						result2 = stm2.executeQuery("select a.title, a.arti_date, a.arti_txt, u.username, u.user_id from article as a inner join user as u using(user_id) where a.arti_id="+arti_id+" group by arti_id");
					} catch (Exception e) {
						e.printStackTrace();
						System.out.println("查詢發生錯誤!");
					}
