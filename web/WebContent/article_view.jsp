...
<body class="page article_in">
	...
	<div class="indica">
		<div class="container">
				...
				try {
					result = stm.executeQuery("select * from (select * from article where board_id="+board_id+" and arti_id="+arti_id+") article inner join board using(board_ID) inner join user using(user_id) group by arti_id");
                        ...
                        <div class="info_box">
                            ...
                            <div>
                                ...
                                <span class="art_num">
                                    ...
                                    %>
                                    <font><i class="far fa-comment"></i> <%=result.getString("arti_date") %></font>
