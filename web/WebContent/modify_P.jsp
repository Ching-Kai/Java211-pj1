...
<div class="indica">
	...
	%>
		...
		<form class="" name="useraddform" id="useraddform" method='get' action="http://localhost:8080/web/MemberUpdates">
				...
				<div class="control-group">
				<label class="control-label" for='user_name'>姓名</label><input class="control" type='text' name='username'
					value='<%=username%>'></input>
				</div>

				<div class="control-group">
				<label class="control-label" for='email'>信箱 </label><input  class="control" name="email" type="email"
					value="<%=email%>">
				</div>
